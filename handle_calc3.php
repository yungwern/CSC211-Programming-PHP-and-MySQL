...
<body>
<?php // Script 4.2 - handle_calc3.php
 /* This script takes values from calculator.html and perfoms
 ...
 // Appply the proper formatting:
 $total = number_format($total, 2);
 $monthly = number_format($monthly, 2);
 
 // Print out the results:
 print "<p>You have selected to purchase:<br>
 <span class=\"number\">$quantity</span> widets(s) at <br>
 <span class=\"number\">$price</spand> price each plus a <br>
